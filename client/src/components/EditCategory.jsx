        ...
        <section className='fixed top-0 bottom-0 left-0 right-0 p-4 bg-neutral-800/60 flex items-center justify-center'>
            <div className='bg-white max-w-4xl w-full p-4 rounded'>
                ...
                <form className='my-3 grid gap-2' onSubmit={handleSubmit}>
                    <div className='grid gap-1'>
                        ...
                        <input
                            ...
                            className='bg-blue-50 p-2 border
                                     border-blue-100 
                                     focus-within:border-[var(--color-primary-200)]
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex gap-4 flex-col lg:flex-row items-center'>
                            <div className='border
                                     border-slate-200
                                     bg-blue-50
                                     h-36 w-full lg:w-36 flex items-center 
                    ...
                    <button
                        className={`
                                ${data.name && data.image ? "bg-[var(--color-primary-200)] hover:bg-[var(--color-primary-100)]" : "bg-gray-300"}   
                                py-2 
                                font-semibold`}
