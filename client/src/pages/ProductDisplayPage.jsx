    ...
    return (
        <section className='container mx-auto p-4 grid lg:grid-cols-2'>
            <div className=''>
                ...
                <div className='flex items-center justify-center gap-3 my-2'>
                    {
                        data.image.map((img, index) => {
                            return (
                                <div
                                    key={img + index + "point"}
                                    className={`lg:w-5 lg:h-5 w-3 h-3 rounded-full ${index === image ? "bg-slate-300" : "bg-slate-200"}`}>
                                </div>
                ...
                <div className='grid relative'>
                    ...
                    <div className='w-full -ml-3 h-full flex justify-between absolute items-center  '>
                        <button onClick={handleScrollLeft} className='hidden md:flex z-10 bg-white relative p-1 rounded-full shadow-lg'>
                            <FaAngleLeft />
                        </button>
                        <button onClick={handleScrollRight} className='hidden md:flex z-10 bg-white relative p-1 rounded-full shadow-lg'>
                            <FaAngleRight />
                        </button>
                    </div>
                </div>
            ...
            <div className='p-4 lg:pl-7 text-base lg:text-lg'>
                ...
                {
                    data.stock === 0 ? (
                        <p className='text-lg text-red-500 my-2'>Out of Stocks</p>
                    ) : (
